...
class ParallelIPCHandler:
    ...
    async def handle_batch_interview(self, command_id: str, interviews: List[Dict], platform: str = None) -> bool:
        ...
        if results:
            ...
            self.send_response(command_id, "failed", error="No interview completed successfully")
            return False
...
async def main():
    ...
    log_manager.info(f"  - Total simulation length: {total_hours} hours")
    ...
    if wait_for_commands:
        log_manager.info("")
        log_manager.info("=" * 60)
        log_manager.info("Entering wait-for-command mode. Environment remains active")
