<template>
  ...
  >
    ...
    <div class="section-header">
      ...
      <span class="section-title">캠페인 기록</span>
      <div class="section-line"></div>
    </div>
      ...
      >
        ...
        <div class="card-files-wrapper">
          ...
          <div class="files-list" v-if="project.files && project.files.length > 0">
            ...
            <!-- Show a hint when there are more files. -->
            <div v-if="project.files.length > 3" class="files-more">
              +{{ project.files.length - 3 }}개 더
            </div>
          </div>
          ...
          <div class="modal-content">
            ...
            <div class="modal-body">
              ...
              <div class="modal-section">
                ...
                <div class="modal-empty" v-else>연결된 문서 없음</div>
              </div>
            </div>
            ...
            <div class="modal-divider">
              ...
              <span class="divider-text">재진입</span>
              <span class="divider-line"></span>
            </div>
            ...
            <div class="modal-actions">
              ...
              >
                ...
                <span class="btn-icon">◈</span>
                <span class="btn-text">유권자 모델링</span>
              </button>
              <button 
              ...
              >
                ...
                <span class="btn-icon">◆</span>
                <span class="btn-text">전략 보고서</span>
              </button>
            </div>
            <!-- Replay limitation note -->
            <div class="modal-playback-hint">
              <span class="hint-text">Step 3 캠페인 실행과 Step 5 워룸 Q&A는 실행 중에만 시작할 수 있으며, 기록 재생으로는 열 수 없습니다.</span>
            </div>
          </div>
        </div>
      </Transition>
